...
public class HumanStandardTokenAlaya extends Contract {
	...
	protected HumanStandardTokenAlaya(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId) {
		super(BINARY, contractAddress, web3j, credentials, contractGasProvider,chainId);
	}

	protected HumanStandardTokenAlaya(String contractAddress, Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider, Long chainId) {
	...
	public static RemoteCall<HumanStandardTokenAlaya> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider,
		...
		return deployRemoteCall(HumanStandardTokenAlaya.class, web3j, credentials, contractGasProvider, BINARY, encodedConstructor,chainId);
	}

	public static RemoteCall<HumanStandardTokenAlaya> deploy(Web3j web3j, TransactionManager transactionManager, GasProvider contractGasProvider,
                                                             BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol, Long chainId) {
		String encodedConstructor = FunctionEncoder.encodeConstructor(
				Arrays.<Type>asList(new Uint256(_initialAmount), new Utf8String(_tokenName),
						new Uint8(_decimalUnits), new Utf8String(_tokenSymbol)));
		return deployRemoteCall(HumanStandardTokenAlaya.class, web3j, transactionManager, contractGasProvider, BINARY, encodedConstructor,chainId);
	}
	...
	public static HumanStandardTokenAlaya load(String contractAddress, Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId) {
		return new HumanStandardTokenAlaya(contractAddress, web3j, credentials, contractGasProvider,chainId);
	}

	public static HumanStandardTokenAlaya load(String contractAddress, Web3j web3j, TransactionManager transactionManager,
                                               GasProvider contractGasProvider, Long chainId) {
		return new HumanStandardTokenAlaya(contractAddress, web3j, transactionManager, contractGasProvider,chainId);
	}
